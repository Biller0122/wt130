    ...
    <div style={{ display: 'flex', height: '100vh', overflow: 'hidden' }}>
      ...
      <aside style={{ width: '200px', background: '#13151f', borderRight: '1px solid #1e2132', display: 'flex', flexDirection: 'column', height: '100vh', flexShrink: 0 }}>
        <div style={{ padding: '1.25rem 1rem', borderBottom: '1px solid #1e2132', display: 'flex', alignItems: 'center', gap: '0.625rem' }}>
          ...
          <div>
            <div style={{ fontSize: '0.875rem', fontWeight: 700, color: '#f1f5f9', letterSpacing: '-0.01em' }}>WT130 Service</div>
        ...
        <div style={{ padding: '0.75rem 0.625rem', borderTop: '1px solid #1e2132' }}>
          ...
          <button
            ...
            onMouseEnter={e => { (e.currentTarget as HTMLElement).style.background = '#1e1a2e'; (e.currentTarget as HTMLElement).style.color = '#f87171'; (e.currentTarget as HTMLElement).style.borderColor = '#3d1515' }}
            onMouseLeave={e => { (e.currentTarget as HTMLElement).style.background = 'transparent'; (e.currentTarget as HTMLElement).style.color = '#64748b'; (e.currentTarget as HTMLElement).style.borderColor = 'transparent' }}
          >
